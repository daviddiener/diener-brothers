...
meta_title: ""
# meta description
description: "Privacy Policy for Diener Brothers"
# save as draft
draft: false
---
...
## 3. Links zu Drittplattformen (Steam)
Wir verlinken auf unsere Store-Page auf Steam (Valve Corp.). Wenn Sie diesen Link anklicken, verlassen Sie unsere Website. Die Datenverarbeitung auf Steam unterliegt den Datenschutzbestimmungen von Valve. Wir erhalten von Valve lediglich anonymisierte Verkaufsstatistiken, jedoch keine personenbezogenen Daten der Käufer.

## 4. Datenerhebung bei Kontaktaufnahme
Wenn Sie uns per E-Mail kontaktieren, speichern wir Ihre Angaben zur Bearbeitung der Anfrage sowie für den Fall von Anschlussfragen (Art. 6 Abs. 1 lit. b DSGVO).
